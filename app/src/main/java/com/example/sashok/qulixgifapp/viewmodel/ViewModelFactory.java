...
public interface ViewModelFactory {
    ...
    @NonNull
    DetailViewModel createDetailViewModel(@NonNull Context context,
                                          @Nullable ViewModel.State savedViewModelState);

    @NonNull
    GifListViewModel createGifListViewModel(
            @NonNull GifListAdapter adapter,
            @NonNull Context context,
            @Nullable ViewModel.State savedViewModelState);

    @NonNull
    GifItemViewModel createGifItemViewModel(
            @NonNull Context context);
